                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <input type="tel" class="form-control form-control-user" id="phone"
                                       placeholder="Phone (0412345678)" name="phone" >
                            </div>
                              ...
                              <div class="form-group row">
                                  <div id="roleDiv">
                                      <select class="browser-default custom-select form-select" id="campus" >
                                         <option value="Select Role" selected>Select Campus</option>
                                          <option value="0">Colaroo/Roxburgh Park</option>
                                          <option value="1">Broadmeadows/Campbellfield</option>
                                          <option value="2">Greater Shepparton</option>
                            ...
                            <div id="studentData">
                              ...
                              <div class="mb-3">
                                  <input type="text" class="form-control form-control-user" id="ReferredBy"
                                         placeholder="Referred By (Optional)" name="referredby">
                              </div>
